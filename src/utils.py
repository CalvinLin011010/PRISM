...
def parse_args():
    ...
    # basic args
    parser.add_argument("--data_dir", default="./src/data/", type=str)
    ...
    parser.add_argument("--texfilter_as_weight", default=1, type=int)


    parser.add_argument("--cluster_alpha", default=0.5, type=float)
    parser.add_argument("--num_intents", default=16, type=int)
    


    args, _ = parser.parse_known_args()

    if 'bsarec' in args.model_type.lower():

        parser.add_argument("--filter_type", type=str, default="filter3") #filter3 filter4 
        parser.add_argument("--mymodel", type=str, default="filter3") #filter3 filter4 
        parser.add_argument("--layers", type=int, default=2)
        parser.add_argument("--group", type=int, default=8)
        parser.add_argument("--c", type=int, default=3)
        parser.add_argument("--alpha", type=float, default=0.9, help="hyperparameter for FFT")
